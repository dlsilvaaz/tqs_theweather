...
public class DailyForecast {
	...
	public String toString() {
		return "DailyWather [precipitaProb=" + precipitaProb + ", tMin=" + tMin + ", tMax=" + tMax + ", predWindDir="
				+ predWindDir + ", idWeatherType=" + idWeatherType + ", classWindSpeed=" + classWindSpeed
				+ ", longitude=" + longitude + ", forecastDate=" + forecastDate + ", classPrecInt=" + classPrecInt
				+ ", latitude=" + latitude + "]";
	}
